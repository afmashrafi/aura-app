      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="relative">
          <input
            ...
            id={inputId}
            type={inputType}
            className={`w-full h-11 px-4 bg-surface text-ink placeholder-ink-muted rounded-[12px] border ${
              error
                ? "border-danger focus:ring-danger"
                : "border-divider focus:ring-focus-ring"
            } focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-150 text-base ${
              isPassword ? "pr-11" : ""
            } ${className}`}
            {...props}
          />
